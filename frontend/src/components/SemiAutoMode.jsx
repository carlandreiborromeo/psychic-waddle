// // ===== src/components/SemiAutoMode.jsx =====
...
//         <h2 className="text-xl font-semibold text-gray-800 mb-4">Semi-Automatic Mode</h2>
...
//           className="flex items-center space-x-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors text-lg font-medium"
//         >
...
//             <div>
//               <div className="text-lg font-semibold text-blue-900">Test in Progress</div>
